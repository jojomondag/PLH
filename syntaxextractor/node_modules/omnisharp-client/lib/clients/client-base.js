...
var _pluginManager = require("../helpers/plugin-manager");
...
var ClientBase = (function () {
    function ClientBase(_options, observableFactory) {
        ...
        this._plugins = new _pluginManager.PluginManager(_options.projectPath, _options.plugins);
    ...
    _createClass(ClientBase, [{
        ...
        value: function connect() {
            if (this.currentState === _enums.DriverState.Connected || this.currentState === _enums.DriverState.Connecting) return;
