...
export declare class ObservationClientV1<T extends ClientV1> extends ObservationClientBase<T> implements Events.V1 {
    ...
    readonly getcodeactions: Rx.Observable<Context<Models.GetCodeActionRequest, Models.GetCodeActionsResponse>>;
    ...
    readonly runcodeaction: Rx.Observable<Context<Models.RunCodeActionRequest, Models.RunCodeActionResponse>>;
...
export declare class AggregateClientV1<T extends ClientV1> extends CombinationClientBase<T> implements Events.Aggregate.V1 {
    ...
    readonly getcodeactions: Rx.Observable<CombinationKey<Context<Models.GetCodeActionRequest, Models.GetCodeActionsResponse>>[]>;
    ...
    readonly runcodeaction: Rx.Observable<CombinationKey<Context<Models.RunCodeActionRequest, Models.RunCodeActionResponse>>[]>;
